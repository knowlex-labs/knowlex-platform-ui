...
export function AdminLoginPage() {
  ...
  if (isRestoringSession) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-ledger-50 dark:bg-ledger-950">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-ledger-50 dark:bg-ledger-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border border-ledger-200 dark:border-ledger-800 bg-white dark:bg-ledger-900 p-6">

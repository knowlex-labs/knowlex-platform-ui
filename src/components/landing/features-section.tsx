...
export function FeaturesSection() {
  return (
    <section id="features" className="py-16 md:py-24 bg-ledger-gray-50">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="bg-ledger-white p-6 md:p-8 rounded-lg border border-ledger-gray-200"
            >
              <div className="w-12 h-12 bg-ledger-gray-100 rounded-lg flex items-center justify-center mb-4">
                <feature.icon className="w-6 h-6 text-ledger-black" />
              </div>
              <h3 className="text-xl font-serif font-semibold text-ledger-black mb-3">
                {feature.title}
              </h3>

    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 p-3 space-y-3 overflow-hidden">
        ...
        <div className="flex justify-end">
          <div className="max-w-[75%]">
            ...
            <div className="rounded-xl rounded-br-sm bg-[#7a2e2e] text-white px-2.5 py-1.5">
        ...
        <div>
          ...
          <div className="pl-0.5 text-[9px] text-[#2d1518] leading-relaxed space-y-1.5">
            <p>
            ...
            <p className="text-ledger-gray-600">
              In <span className="font-medium text-[#7a2e2e]">Arnesh Kumar v. State of Bihar (2014) 8 SCC 273</span>, the Supreme Court laid down guidelines...
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 pb-2.5 pt-1">
        <div className="flex items-center gap-1.5 border border-ledger-gray-200 rounded-full px-2.5 py-1.5 bg-ledger-white shadow-sm">
          ...
          />
          <div className="h-5 w-5 rounded-full bg-[#7a2e2e] flex items-center justify-center">

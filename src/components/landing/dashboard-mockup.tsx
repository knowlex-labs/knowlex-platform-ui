...
export function DashboardMockup() {
  return (
    <div
      className="rounded-xl shadow-2xl overflow-hidden border border-ledger-gray-200/60 transition-transform duration-500 hover:scale-[1.01]"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 bg-slate-800">
        ...
        <span className="text-[11px] text-ledger-gray-400 ml-2 font-medium">Knowlex</span>
      </div>

      {/* Content area */}
      <div className="flex bg-ledger-white h-[280px] sm:h-[320px]">
        {/* Sidebar */}
        ...
        {/* Main content */}
        <div className="flex flex-1 min-w-0 divide-x divide-ledger-gray-100">
          <div className="w-[55%]">
            <CaseListPanel />
          </div>
          <div className="w-[45%]">

...
export function DraftItem({ draft, onEdit, onDelete, onDownload }: DraftItemProps) {
  return (
    <div className="group p-3 rounded-lg border border-ledger-gray-200 bg-ledger-white hover:border-ledger-gray-300 transition-colors">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="text-sm font-medium text-ledger-black truncate">
            {draft.title}
          </h4>

        ...
        <table className="w-full text-sm">
            <thead className="sticky top-0 z-20">
                <tr className="bg-ledger-gray-50 dark:bg-ledger-gray-100 border-b border-kx-card-border [&>th]:bg-ledger-gray-50 dark:[&>th]:bg-ledger-gray-100">
                    ...
                    <th className="text-left px-4 py-2 font-medium text-ledger-gray-600 text-xs uppercase tracking-wider whitespace-nowrap">Title</th>
                    <th className="text-left px-4 py-2 font-medium text-ledger-gray-600 text-xs uppercase tracking-wider whitespace-nowrap hidden lg:table-cell">Court</th>
                    <th className="text-left px-4 py-2 font-medium text-ledger-gray-600 text-xs uppercase tracking-wider whitespace-nowrap hidden md:table-cell">Judge(s)</th>
                    <SortableHeader label="Decision Date" field="decisionDate" sorts={sorts} onToggle={toggleSort} />
                    <th className="text-left px-4 py-2 font-medium text-ledger-gray-600 text-xs uppercase tracking-wider whitespace-nowrap hidden xl:table-cell">Verdict</th>
                </tr>
            </thead>
        ...
        <table className="w-full text-sm">
            <thead>
                <tr className="bg-ledger-gray-50 dark:bg-ledger-gray-100 border-b border-kx-card-border">
                    <th className="text-left px-4 py-2"><div className="h-3 w-20 bg-ledger-gray-200 rounded animate-pulse" /></th>
                    <th className="text-left px-4 py-2"><div className="h-3 w-16 bg-ledger-gray-200 rounded animate-pulse" /></th>
                    <th className="text-left px-4 py-2 hidden lg:table-cell"><div className="h-3 w-14 bg-ledger-gray-200 rounded animate-pulse" /></th>
                    <th className="text-left px-4 py-2 hidden md:table-cell"><div className="h-3 w-16 bg-ledger-gray-200 rounded animate-pulse" /></th>
                    <th className="text-left px-4 py-2"><div className="h-3 w-12 bg-ledger-gray-200 rounded animate-pulse" /></th>
                    <th className="text-left px-4 py-2 hidden xl:table-cell"><div className="h-3 w-16 bg-ledger-gray-200 rounded animate-pulse" /></th>
                </tr>
            </thead>
            <tbody className="divide-y divide-kx-card-border">

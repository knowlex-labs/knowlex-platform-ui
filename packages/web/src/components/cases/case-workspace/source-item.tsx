...
import { DocumentType, GENERATED_DOC_TYPES } from '@knowlex/core/types'
...
function getStatusBadge(status: string | undefined | null) {
  const config: Record<string, { color: string; text: string }> = {
    ...
    processing: { color: 'bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-900/30 dark:text-blue-400 dark:border-blue-800', text: 'Indexing' },
    ...
    indexing_running: { color: 'bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-900/30 dark:text-blue-400 dark:border-blue-800', text: 'Indexing' },
      ...
      {isRenaming ? (
        <div className="flex items-center gap-2 flex-1 min-w-0" onClick={(e) => e.stopPropagation()}>
          ...
          <input
            ...
            className="text-sm text-kx-primary-900 flex-1 min-w-0 bg-nb-input border border-kx-primary-300 rounded px-1.5 py-0.5 outline-none focus:border-kx-primary-500 cursor-text select-text"
          />
          {nameExt && (
